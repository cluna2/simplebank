...
const file_service_simplebank_proto_rawDesc = "" +
	"\n" +
	"\x18service_simplebank.proto\x12\x02pb\x1a\x1cgoogle/api/annotations.proto\x1a\x15rpc_create_user.proto\x1a\x14rpc_login_user.proto\x1a.protoc-gen-openapiv2/options/annotations.proto2\xad\x02\n" +
	"\n" +
	"Simplebank\x12\x86\x01\n" +
	"\n" +
	"CreateUser\x12\x15.pb.CreateUserRequest\x1a\x16.pb.CreateUserResponse\"I\x92A,\x12\x0fCreate new user\x1a\x19Used to create a new user\x82\xd3\xe4\x93\x02\x14:\x01*\"\x0f/v1/create_user\x12\x95\x01\n" +
	"\tLoginUser\x12\x14.pb.LoginUserRequest\x1a\x15.pb.LoginUserResponse\"[\x92A?\x12\n" +
	"Login user\x1a1Used to login a user and get access/refresh token\x82\xd3\xe4\x93\x02\x13:\x01*\"\x0e/v1/login_userBh\x92AD\x12B\n" +
	"\x0fSimple Bank API\"*\n" +
	"\rCristian Luna\x12\x19https://github.com/cluna22\x031.1Z\x1fgithub.com/cluna2/simplebank/pbb\x06proto3"
